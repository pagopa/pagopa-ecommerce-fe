jest.mock('../../config/config', () => ({
  ...
  jest.mock('../../../../generated/definitions/payment-ecommerce-webview-v2/client', () => ({
    createClient: jest.fn(() => ioClientMock),
  }));
  jest.mock('../../../../generated/definitions/payment-ecommerce-v1/client', () => ({
    createClient: jest.fn(() => checkoutClientMock),
  }));
  jest.mock('../../../../generated/definitions/payment-ecommerce-v2/client', () => ({
  ...
  describe('clientWithPolling module', () => {
    ...
    it('creates CHECKOUT v2 client with polling', () => {
      ...
      expect(args.fetchApi).toBe('fetchApiMock');
      expect(ecommerceCHECKOUTClientClientWithPollingV2).toBe(checkoutV2ClientMock);
    });
  });
